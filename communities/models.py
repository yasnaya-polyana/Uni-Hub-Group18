...
class Communities(SoftDeleteModel):
    ...
    owner = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name="owned_communities")
...
class CommunityMember(SoftDeleteModel):
    ...
    community = models.ForeignKey(Communities, on_delete=models.CASCADE, related_name="community_members")
